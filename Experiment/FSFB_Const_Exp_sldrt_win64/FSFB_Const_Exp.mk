...
MODEL                := FSFB_Const_Exp
MODULES              := rt_matrx.c rt_printf.c FSFB_Const_Exp_data.c FSFB_Const_Exp_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c barrierIMILog.c
MAKEFILE             := FSFB_Const_Exp.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := FSFB_Const_Exp_ref.rsp
...
# additional includes
REQ_INCLUDES += ;C:/Users/Mesih/Documents/MATLAB/Samet/FSFB_Const/Experiment;C:/Users/Mesih/Documents/MATLAB/Samet/FSFB_Const/Experiment/FSFB_Const_Exp_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
